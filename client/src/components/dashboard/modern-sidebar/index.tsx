...
export function ModernSidebar({
  ...
  // Example navigation items - in a real app, these would come from props
    ...
    <TooltipProvider>
      ...
      <div
        ...
        className={cn(
          ...
          "transition-all duration-300 h-screen fixed lg:sticky top-0",
          collapsed ? "lg:w-16" : "lg:w-64", 
          mobileOpen ? "w-64 translate-x-0 shadow-xl" : "w-0 -translate-x-full lg:translate-x-0 lg:w-auto",
          className
        )}
                          ...
                          <div className="relative">
                            ...
                            {isGroupExpanded && (
                              <ul
                                ...
                                className={cn(
                                  collapsed 
                                    ? "absolute left-full top-0 mt-0 ml-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-gray-700 py-1 z-20" 
                                ...
                                {item.children.map(child => (
                                  <li key={child.href} role="none">
                                    <a
                                      href={child.href}
                                      className={cn(
                                        "flex items-center transition-colors py-2 px-3 text-sm",
                                        collapsed ? "px-4" : "",
