 ...
 * 
 * Uses the EnhancedSidebar component and provides a full layout structure
 * with proper content area scrolling and header setup.
 */
export function EnhancedLayout({ children, pageTitle }: EnhancedLayoutProps) {
  ...
  return (
    <div className="h-screen flex flex-col lg:flex-row bg-gray-50 dark:bg-gray-900">
      ...
      <main 
        id="main-content"
        className="flex-1 overflow-auto pt-16 lg:pt-0 lg:ml-[60px] dark:bg-gray-900"
        style={{ 
